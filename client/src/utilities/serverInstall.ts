...
export type InstallAdvice =
     ...
     * `serverVersion` is what did start, if anything: with a server running
     * this is a hole in our table rather than a problem in the user's setup,
     * and the presenter should not treat the two alike.
     */
    | {
