...
Here is a curated list of useful books to learn Rocq (formerly Coq). Most of them predate the rename and say Coq.
...
For a shorter and more hands-on approach to learning Rocq, users can use the following resources.
